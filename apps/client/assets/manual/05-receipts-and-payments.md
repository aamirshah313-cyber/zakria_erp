...
Live list from the worked example: 28-entries-list.json.
...
(45-refused-requests.json, second entry):
...
- **Separation of duties.** Confirming your own submission is refused even when you hold
  both permissions (45-refused-requests.json, last
...
(16-entry-awaiting-approval.json), returned for
correction (17-entry-returned.json), corrected, resubmitted, and
then confirmed (14-receipt-confirmed.json):
...
(18-attachment-uploaded.json,
19-attachment-list.json):
...
| REG-000011–13 | 2026-09-22/24/26 | Imported | See [chapter 7](chapter:07-spreadsheet-import) | | | | 410,200.00 total |
| REG-000014 | 2026-09-20 | Payment | Attock filling station | Fuel and transport | — | Cash | 18,600.00 **awaiting approval** |

Plus one opening balance and one internal transfer, in [chapter 6](chapter:06-openings-and-transfers).
