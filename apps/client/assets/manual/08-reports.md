...
Example for the quarter (29-ledger.json,
30-ledger.csv):
...
fit-out (37b-project-statement.json): receipts
...
|---|---|---|---|---|---|
| Whole company (31) | 0.00 | 1,325,000.00 | 826,150.00 | 150,000.00 | 498,850.00 |
| Main cash box only (37a) | 350,000.00 | 400,000.00 | 487,400.00 | 150,000.00 | 112,600.00 |
...
|---|---|---|
| PDF | 33-register-report.pdf | Company name, logo, title, period, filters, totals, basis, bar chart, table; A4/A3, portrait or landscape, page numbers and footer |
| Excel | 34-register-report.xlsx | Three sheets — Report details, Report rows (frozen heading, filters, number formats, print setup), Grouped summary with a bar chart — each with the logo banner |
| CSV | 36-register-report.csv | Metadata block, then the table; UTF-8 with BOM, and text that starts with `=` is escaped so a spreadsheet cannot execute it |
| PNG / JPEG | 35-register-report.png | A one-page chart summary for sharing, 1,600 px wide with the logo and the totals |
...
(37-saved-report.json). Saved layouts appear in **Saved
...
[Data management](chapter:10-data-management).
