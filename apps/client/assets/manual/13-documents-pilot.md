...
The party list shared with the register ([chapter 4](chapter:04-register-setup)). `parties.view`
...
accounting work is listed in ../V2_DESKTOP_SCOPE.md and
../ADDITIONAL_FINANCE_SCOPE.md.
