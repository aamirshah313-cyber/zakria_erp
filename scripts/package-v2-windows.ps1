...
& $taskDart $taskFlutter build windows --release --no-pub --build-name=2.1.0 --build-number=9 --dart-define=V2_DESKTOP=true --dart-define=API_URL=http://127.0.0.1:8765/api
