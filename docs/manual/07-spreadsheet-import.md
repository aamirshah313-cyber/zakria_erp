...
([24-import-inspect.json](examples/24-import-inspect.json)), so you can see which sheet
...
([23-import-source.csv](examples/23-import-source.csv)):
...
([25-import-preview.json](examples/25-import-preview.json)). Each row shows the values it
...
Result ([26-import-committed.json](examples/26-import-committed.json)):
...
[chapter 4](04-register-setup.md).
