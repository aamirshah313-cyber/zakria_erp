...
([01-health.json](examples/01-health.json)):
...
- **No phone access yet.** An Android test build exists but cannot sign in until a decision
  is made about how phones reach the data (see [chapter 2](02-getting-started.md)).
...
Its headline figures, taken from [31-report-detail.json](examples/31-report-detail.json):
...
All example files are listed in [examples/README.md](examples/README.md).
