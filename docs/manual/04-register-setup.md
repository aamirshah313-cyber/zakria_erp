...
([10-register-setup.json](examples/10-register-setup.json)).

Setup records are never deleted. They are archived and restored through
[Data management](10-data-management.md), so past records keep the name they were recorded
against.
...
Example ([08-category.json](examples/08-category.json)):
...
([09-bank-source.json](examples/09-bank-source.json)):
