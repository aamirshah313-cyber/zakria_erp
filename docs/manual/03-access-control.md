...
example installation: [04-roles-and-permissions.json](examples/04-roles-and-permissions.json).
...
([06-users.json](examples/06-users.json)). An administrator (`users.manage`) sets status
...
2. An administrator opens **Users**, assigns a role and sets the status to **active**
   ([05-user-activated.json](examples/05-user-activated.json)).
...
([45-refused-requests.json](examples/45-refused-requests.json), last entry):
